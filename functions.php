...
{
    echo '<link href="https://' . iro_opt('gfonts_api') . '/css?family=Merriweather+Sans|Noto+Serif+SC&display=swap" rel="stylesheet">' . PHP_EOL;
...
function custom_admin_open_sans_font_frontend_toolbar()
{
    if (current_user_can('administrator') && is_admin_bar_showing()) {
        echo '<link href="https://' . iro_opt('gfonts_api') . '/css?family=Merriweather+Sans&display=swap" rel="stylesheet">' . PHP_EOL;
...
function custom_admin_open_sans_font_login_page()
{
    if (stripos($_SERVER["SCRIPT_NAME"], strrchr(wp_login_url(), '/')) !== false) {
        echo '<link href="https://' . iro_opt('gfonts_api') . '/css?family=Noto+Serif+SC&display=swap" rel="stylesheet">' . PHP_EOL;
