...
function gravatar_cn($url)
{
    ...
    return str_replace( $gravatar_url, 'sdn.geekzu.org/avatar/', $url );
}
...
{
    echo '<link href="https://fonts.googleapis.com/css?family=Ma+Shan+Zheng&display=swap" rel="stylesheet">' . PHP_EOL;
