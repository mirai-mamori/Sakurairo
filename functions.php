...
function custom_html()
{
    if (akina_option('login_bg')) {
        ...
        $loginbg = 'https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@0.1.7/vision/background/backstage/login-bg.png';
    }
    echo '<script type="text/javascript" src="' . get_template_directory_uri() . '/js/login.js"></script>' . "\n";
    echo '<script type="text/javascript">' . "\n";
    echo 'jQuery("body").prepend("<div class=\"loading\"><img src=\"https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository@0.1.7/vision/basic/login_loading.gif" width=\"58\" height=\"10\"></div><div id=\"bg\"><img /></div>");' . "\n";
