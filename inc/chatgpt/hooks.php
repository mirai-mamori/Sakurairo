...
namespace IROChatGPT {
    ...
    function call_chatgpt_for_annotations($content) {
        ...
        // 构建提示词
        $prompt = "分析以下文章正文内容(排除标题及引语类文本)，用较为严格的标准识别并挑选出专业术语、复杂概念、生僻、网络黑话烂梗、事件(最高优先级，重点识别，并结合上下文提到的时间进行判断)、网络热词、晦涩难懂、与文章语言不同的名词，并根据文章主要语言提供对应语言的简短解释。名词选取时需要考虑到时效性，优先解释新名词，同时排除日常常用的名词、非著名人物的人名，仅返回JSON格式，格式为：{\"术语1\":\"解释1\", \"术语2\":\"解释2\", ...}。至少返回5个最重要的术语：\n\n" . $content;
