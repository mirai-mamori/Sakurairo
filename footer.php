...
?>
	...
	<div id="mo-nav">
		<div class="m-avatar">
			...
			$ava = iro_opt('personal_avatar') ? $personal_avatar: ($iro_logo ?: iro_opt('vision_resource_basepath','https://cdn.jsdelivr.net/gh/Fuukei/Sakurairo_Vision@latest/').'series/avatar.jpg'); ?>
