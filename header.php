...
<head>
    ...
    <link rel="stylesheet" href="<?php echo (iro_opt('fontawesome_source','https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css') ?? 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css')?>" type="text/css" media="all" />
    <?php
    if (iro_opt('iro_meta')) {
