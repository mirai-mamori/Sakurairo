...
?>
    ...
    <?php if (iro_opt('socialdiy1')) { ?>
        <li><a href="<?php echo iro_opt('socialdiy1', ''); ?>" target="_blank" class="social-wangyiyun" title="<?php echo iro_opt('socialdiy1_title', 'DIY1'); ?>"><img src="<?php echo iro_opt('socialdiyp1'); ?>" /></a></li>
    <?php } ?>
    <?php if (iro_opt('socialdiy2')) { ?>
        <li><a href="<?php echo iro_opt('socialdiy2', ''); ?>" target="_blank" class="social-wangyiyun" title="<?php echo iro_opt('socialdiy2_title', 'DIY2'); ?>"><img src="<?php echo iro_opt('socialdiyp2'); ?>" /></a></li>
    <?php } ?>
