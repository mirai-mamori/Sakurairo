...
<div class="headertop-down faa-float animated" onclick="headertop_down()"><span><i class="fa-solid fa-chevron-down" style="color:<?php echo iro_opt('drop_down_arrow_color'); ?>"></i></span></div>
<?php endif; ?>