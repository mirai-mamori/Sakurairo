...
?>
    ...
    <div class="slider-container">
        <div class="prev">
            <svg style="width: 35px;height: 35px;fill: currentColor;" viewBox="0 0 1024 1024">
                <path
	...
	<script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            window.addEventListener("resize", () => {
                checkSliderButtonsVisibility(); // 重新检查按钮的可见性
            ...
            // 初始化
            updateSlider();
            checkSliderButtonsVisibility(); // 初始检查按钮的可见性
        });
