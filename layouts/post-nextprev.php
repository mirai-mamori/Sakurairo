...
<section class="post-squares nextprev">
	...
	<div class="post-nepre <?php if(get_next_post(false, $classify_display_id)){echo 'half';}else{echo 'full';} ?> previous">
	...
	<div class="post-nepre <?php if(get_previous_post(false, $classify_display_id)){echo 'half';}else{echo 'full';} ?> next">
