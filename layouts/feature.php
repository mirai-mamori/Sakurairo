...
?>
	<div class="top-feature">
		...
		<div class="feature-content">
			<li class="feature-1">
				<a href="<?php echo akina_option('feature1_link', '#'); ?>" target="_blank"><div class="feature-title"><span class="foverlay-bg"></span><span class="foverlay"><?php echo akina_option('feature1_title', 'feature1'); ?></span></div><img class="lazyload" src="https://cdn.jsdelivr.net/gh/mirai-mamori/web-img@1.0/loadimg/outload.svg" data-src="<?php echo akina_option('feature1_img', ''); ?>"></a>
			</li>
			<li class="feature-2">
