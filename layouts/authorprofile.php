...
?>
	<section class="author-profile">
		...
		<hr>
		<p><i class="iconfont icon-write"></i><?php echo get_the_author_meta( 'description' ) ? get_the_author_meta( 'description' ) :akina_option('admin_destwo', 'Carpe Diem and Do what I like'); ?></p>
	</section>
