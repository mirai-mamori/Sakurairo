...
function optionsframework_options()
{
   ...
   $options[] = array(
    ...
    //首页封面设置
    $options[] = array(
        'name' => __('Cover(Homepage)', 'sakurairo'), 
        'type' => 'heading');
   ...
   */
    ...
    //首页内容设置
    $options[] = array(
        'name' => __('Content(Homepage)', 'sakurairo'), 
        'type' => 'heading');
    ...
    //首页聚焦设置
    $options[] = array(
        'name' => __('Focus(Homepage)', 'sakurairo'), 
        'type' => 'heading');
    ...
    //评论相关设置
    $options[] = array(
        'name' => __('Comments Related', 'sakurairo'), 
        'type' => 'heading');
