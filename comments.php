          ...
          <nav id="comments-navi">
			...
			<?php
				...
				if(comments_open()){
					...
					$mail_notify = iro_opt('mail_notify') ? '<label class="siren-checkbox-label"><input class="siren-checkbox-radio" type="checkbox"checked name="mail-notify"><span class="siren-mail-notify-checkbox siren-checkbox-radioInput"></span>'.__('Comment reply notify', 'sakurairo').'</label>' : '';
					$smilies_panel = '';
					$bilibili_smilies = '';
					$tieba_smilies = '';
					$menhera_smilies = '';
